...
pretrained = None
# load_from = '/home/sunhnayu/lln/project/MMLAB/mmsegmentation/my_mmseg_pretrain_model/swinv2-large-w24_in21k-pre_3rdparty_in1k-384px_20220803-3b36c165.pth'
load_from = None
...
data_root = '/mnt/workspace/project/MMLAB/mmsegmentation/my_mmseg_data/kvasir_seg'
dataset_type = 'MyDataset'
default_hooks = dict(
    # checkpoint=dict(
    #     by_epoch=False, interval=5000, save_best='mIoU',
    #     type='CheckpointHook'),
    checkpoint=dict(by_epoch=False, interval=1000, type='CheckpointHook',save_best=save_best,max_keep_ckpts=max_keep_ckpts),
...
work_dir = '../work_dirs/hpc0510mask2former_swin-l-in22k-384x384-pre_8xb2-160k_ade20k-640x640'
