...
load_from = '/home/sunhnayu/lln/project/MMLAB/mmsegmentation/my_mmseg_pretrain_model/mask2former_swin-l-in22k-384x384-pre_8xb2-160k_ade20k-640x640_20221203_235933-7120c214.pth'
# pretrained = None
...
default_hooks = dict(
    ...
    #     type='CheckpointHook'),
    checkpoint=dict(by_epoch=False, interval=checkpoint_interval, type='CheckpointHook',save_best=save_best,max_keep_ckpts=max_keep_ckpts),
...
model = dict(
    backbone=dict(
        ...
        # frozen_stages=-1,
        frozen_stages=3,
        init_cfg=dict(checkpoint=pretrained,type='Pretrained'),
        mlp_ratio=4,
        num_heads=[
            6,
            12,
...
work_dir = '../work_dirs/hpc05181757_mask2former_swin-l-in22k-384x384-pre_8xb2-160k_ade20k-640x640.py'
