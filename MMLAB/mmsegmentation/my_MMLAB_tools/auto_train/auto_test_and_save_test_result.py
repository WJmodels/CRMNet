...
if __name__ == "__main__":
    ...
    model_work_dir_path = [r"/mnt/workspace/project/MMLAB/work_dirs/convnetv2/hpc05241555_topk_mask2former_RFAin_up_convnetv2-l_123",r"/mnt/workspace/project/MMLAB/work_dirs/convnetv2/hpc05241555_topk_mask2former_RFAin_up_convnetv2-l_tt"]
    # model_work_dir_path = r"/mnt/workspace/project/MMLAB/work_dirs/convnetv2/hpc05241555_topk_mask2former_RFAin_up_convnetv2-l_tt"
    # 调用示例
    # auto_test(model_work_dir_path, dist_test_script)
    auto_test_and_save_test_result(model_work_dir_path, dist_test_script, class_name)
