...
if __name__ == '__main__':
    # 示例用法
    # 先获取目标日志文件路径
    list_target_log_path = find_target_logs(r'E:\HPC\最佳权重整理\Ulcer_New\hpc06091027_RFAinout_Dys_RatUlcer__mask2former_convnextv2-l_2', 'Iter(test)')
    print(list_target_log_path)
    
    
    # 保存所有日志文件的测试结果
    class_name = 'Stomach_Tissue'
    save_folder_path = r'E:\HPC\最佳权重整理\Ulcer_New\excel'
