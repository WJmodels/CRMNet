...
# 示例调用
list_checkpoint_and_config_folder_path = get_subdirectories(r"/mnt/workspace/project/MMLAB/mmsegmentation/my_mmseg_data/Infarction最佳权重和配置文件")
img_path = get_image_paths_from_folder(r"/mnt/workspace/project/MMLAB/mmsegmentation/my_mmseg_data/Rat_Cerebral_Infarction/img_dir/val")
save_path = r'/mnt/workspace/project/MMLAB/work_dirs/推理结果/Rat_Cerebral_Infarction_val_set'
