...
if __name__ == "__main__":
    ...
    model_work_dir_path = [r"/home/sunhnayu/lln/project/MMLAB/work_dirs/classic_model/Ulcer/hpc240611_unet-s5-d16_deeplabv3_4xb4-40k_hrf-256x256"]
    ...
    print(f"model_work_dir_path:{model_work_dir_path}")
