...
if __name__ == "__main__":
    ...
    # model_work_dir_path = get_subdirectories(r"/home/sunhnayu/lln/project/MMLAB/work_dirs/convnextv2/RFAinout_DySample_TTA")
    model_work_dir_path = [r"/home/sunhnayu/lln/project/MMLAB/work_dirs/convnextv2/hpc06091027_RFAinout_Dys_RatUlcer__mask2former_convnextv2-l"]
    # 调用示例
    # auto_test(model_work_dir_path, dist_test_script)
