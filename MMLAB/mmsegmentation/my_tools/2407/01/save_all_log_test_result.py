...
if __name__ == '__main__':
    # 示例用法
    # 先获取目标日志文件路径
    list_target_log_path = find_target_logs('/home/sunhnayu/lln/project/MMLAB/work_dirs/classic_model/Ulcer/hpc240701_unet-s5-d16_deeplabv3_4xb4-40k_hrf-256x256', 'Iter(test)')
    ...
    save_folder_path = '/home/sunhnayu/lln/project/MMLAB/work_dirs/classic_model/Ulcer/hpc240701_unet-s5-d16_deeplabv3_4xb4-40k_hrf-256x256'
