...
def save_one_log_train_result(log_file_path, class_name, save_folder_path, save_as_csv=False,mode="train"):
    """
...
if __name__ == '__main__':
    save_folder_path = r'/mnt/workspace/project/MMLAB/work_dirs/convnetv2/hpc05311723_ade20k_mask2former_convnetv2-l'
    # log_file_path = r"E:\编程\CODE\MMLAB自动化\log文件\20240604_172927.log"
    log_file_path = r"/mnt/workspace/project/MMLAB/work_dirs/convnetv2/hpc05311723_ade20k_mask2former_convnetv2-l/20240531_173837/20240531_173837.log"
    ...
    df = save_one_log_train_result(log_file_path, class_name, save_folder_path, save_as_csv=True)
    print(df)
